...
echo "Testing minimal update (name only)...\n";
try { $data = ["product" => ["name" => [["id" => 1, "value" => "TEST " . date("H:i:s")]]]]; $client->updateProduct($psd->prestashop_product_id, $data); echo "OK: Minimal update works\!\n"; } catch (\Exception $e) { echo "FAIL: " . $e->getMessage() . "\n"; }
