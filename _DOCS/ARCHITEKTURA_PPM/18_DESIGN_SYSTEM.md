...
**Paleta Kolorów MPP TRADE:**
- Primary: #3b82f6 (blue)
- Success: #10b981 (green)
- Warning: #f59e0b (orange)
- Error: #ef4444 (red)

**Typografia:** Inter font, 16px base

**Spacing:** 8px base scale

**Components:** Enterprise Card, Tabs, Buttons
...
## 📖 Nawigacja
- **Poprzedni:** [17. UI/UX](17_UI_UX_GUIDELINES.md)
- **Następny:** [19. Responsive](19_RESPONSIVE_DESIGN.md)
