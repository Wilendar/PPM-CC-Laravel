...
<div x-data="{ open: false }" class="relative">
    ...
    <div x-show="open" 
                        ...
                        <?php $__currentLoopData = Auth::user()->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="px-2 py-0.5 text-xs font-semibold rounded-full
                                       <?php switch($role->name):
                                           case ('Admin'): ?> bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-200 <?php break; ?>
                                           <?php case ('Manager'): ?> bg-orange-100 text-orange-700 dark:bg-orange-900 dark:text-orange-200 <?php break; ?>
                                           <?php case ('Editor'): ?> bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-200 <?php break; ?>
                                           <?php case ('Warehouseman'): ?> bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-200 <?php break; ?>
                                           <?php case ('Salesperson'): ?> bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-200 <?php break; ?>
                                           <?php case ('Claims'): ?> bg-teal-100 text-teal-700 dark:bg-teal-900 dark:text-teal-200 <?php break; ?>
                                           <?php default: ?> bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-200
                                       <?php endswitch; ?>">
        ...
        <div class="py-1" role="none">
            ...
            <a href="<?php echo e(route('admin.system-info')); ?>" 
               class="group flex items-center px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white" 
               role="menuitem">
                <svg class="mr-3 h-5 w-5 text-red-400 group-hover:text-red-500" 
                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="py-1" role="none">
            ...
            <a href="<?php echo e(route('help.shortcuts')); ?>" 
               class="group flex items-center px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white" 
               role="menuitem">
                <svg class="mr-3 h-5 w-5 text-gray-400 group-hover:text-gray-500 dark:group-hover:text-gray-300" 
                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="px-4 py-2 bg-gray-50 dark:bg-gray-700/50">
            <div class="text-xs text-gray-500 dark:text-gray-400 space-y-1">
                <div class="flex justify-between">
                    ...
                    <span><?php echo e(Auth::user()->last_login_at ? Auth::user()->last_login_at->format('d.m.Y H:i') : 'Nigdy'); ?></span>
                </div>
                <div class="flex justify-between">
                    <span>IP:</span>
                    <span><?php echo e(request()->ip()); ?></span>
                </div>
                <div class="flex justify-between">
                    <span>Sesja wygasa:</span>
                    <span id="session-countdown">Za <?php echo e(config('session.lifetime')); ?> min</span>
                </div>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const sessionLifetime = <?php echo e(config('session.lifetime')); ?>; // minutes
...
<?php endif; ?><?php /**PATH D:\Skrypty\PPM-CC-Laravel\resources\views/layouts/user-menu.blade.php ENDPATH**/ ?>