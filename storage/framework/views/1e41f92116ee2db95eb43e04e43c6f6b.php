<?php $__env->startSection('title', 'Logowanie - PPM'); ?>
                ...
                >
                    <div class="flex items-center">
                        ...
                        <div class="ml-3 flex-1">
                            <p class="text-sm font-medium text-red-200"><?php echo e(session('error')); ?></p>
                        </div>
...
$message = $__bag->first($__errorArgs[0]); ?> border-red-400/50 <?php else: ?> border-gray-500/50 <?php unset($message);
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <div class="mt-2 text-sm text-red-300" role="alert"><?php echo e($message); ?></div>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Skrypty\PPM-CC-Laravel\resources\views\auth\login.blade.php ENDPATH**/ ?>