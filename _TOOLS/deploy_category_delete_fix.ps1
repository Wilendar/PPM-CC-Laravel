#!/usr/bin/env pwsh
# Deploy Category Delete Fix 2025-11-27 - Filter pendingDeleteCategories from selected
$ErrorActionPreference = "Stop"

$HostidoKey = "D:\OneDrive - MPP TRADE\SSH\Hostido\HostidoSSHNoPass.ppk"
$RemoteBase = "host379076@host379076.hostido.net.pl:domains/ppm.mpptrade.pl/public_html"

Write-Host "=== DEPLOYING CATEGORY DELETE FIX ===" -ForegroundColor Cyan

Write-Host "[1/5] Uploading ProductForm.php..." -ForegroundColor Yellow
...
Write-Host "[2/5] Uploading ALL assets..." -ForegroundColor Yellow
pscp -i $HostidoKey -P 64321 -r "public/build/assets/*" "$RemoteBase/public/build/assets/"

Write-Host "[3/5] Uploading manifest to ROOT..." -ForegroundColor Yellow
