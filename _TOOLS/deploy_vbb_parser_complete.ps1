# Deploy VBB complete parser update with picture/srcset/sizes/source support
$HostidoKey = "D:\OneDrive - MPP TRADE\SSH\Hostido\HostidoSSHNoPass.ppk"
$RemoteBase = "domains/ppm.mpptrade.pl/public_html"

$files = @(
    @{
        Local = "D:\OneDrive - MPP TRADE\Skrypty\PPM-CC-Laravel\app\Services\VisualEditor\HtmlToBlockDocumentParser.php"
        Remote = "app/Services/VisualEditor/HtmlToBlockDocumentParser.php"
    },
    @{
    ...
    @{
        Local = "D:\OneDrive - MPP TRADE\Skrypty\PPM-CC-Laravel\resources\views\livewire\products\visual-description\block-builder\partials\element-renderer.blade.php"
...
Write-Host "Done! Picture/srcset/sizes/source support deployed." -ForegroundColor Green
