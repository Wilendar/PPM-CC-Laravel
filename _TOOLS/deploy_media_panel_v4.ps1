# Deploy Media Panel V4 Fixes
$HostidoKey = "D:\OneDrive - MPP TRADE\SSH\Hostido\HostidoSSHNoPass.ppk"
$RemoteBase = "host379076@host379076.hostido.net.pl:domains/ppm.mpptrade.pl/public_html"

Write-Host "=== DEPLOYING MEDIA PANEL V4 FIXES ===" -ForegroundColor Cyan
...
Write-Host "[3/5] Uploading media-admin.css..." -ForegroundColor Yellow
