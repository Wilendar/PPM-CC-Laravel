...
Write-Host "=== DEPLOYING MEDIA SYNC ON SAVE FIX ===" -ForegroundColor Cyan

Write-Host "[1/3] Uploading GalleryTab.php..." -ForegroundColor Yellow
...
Write-Host "[2/3] Uploading ProductForm.php..." -ForegroundColor Yellow
