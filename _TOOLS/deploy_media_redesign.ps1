# Deploy Media Panel Redesign
$HostidoKey = "D:\OneDrive - MPP TRADE\SSH\Hostido\HostidoSSHNoPass.ppk"
$RemoteBase = "host379076@host379076.hostido.net.pl:domains/ppm.mpptrade.pl/public_html"

Write-Host "=== DEPLOYING MEDIA PANEL REDESIGN ===" -ForegroundColor Cyan
...
Write-Host "[3/5] Uploading media-admin.css source..." -ForegroundColor Yellow
pscp -i $HostidoKey -P 64321 "resources/css/admin/media-admin.css" "$RemoteBase/resources/css/admin/media-admin.css"

Write-Host "[4/5] Uploading media-manager.blade.php..." -ForegroundColor Yellow
