#!/usr/bin/env pwsh
# Deploy Context-Aware Category Fix 2025-11-27
$ErrorActionPreference = "Stop"

$HostidoKey = "D:\OneDrive - MPP TRADE\SSH\Hostido\HostidoSSHNoPass.ppk"
$RemoteBase = "host379076@host379076.hostido.net.pl:domains/ppm.mpptrade.pl/public_html"

Write-Host "=== DEPLOYING CONTEXT-AWARE CATEGORY FIX ===" -ForegroundColor Cyan
...
Write-Host "[2/5] Uploading category-tree-item.blade.php..." -ForegroundColor Yellow
