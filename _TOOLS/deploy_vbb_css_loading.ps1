# Deploy VBB CSS Loading Fix - PrestaShop CSS in canvas
...
$files = @(
    ...
    @{
        Local = "D:\OneDrive - MPP TRADE\Skrypty\PPM-CC-Laravel\resources\views\livewire\products\visual-description\block-builder\canvas.blade.php"
        Remote = "resources/views/livewire/products/visual-description/block-builder/canvas.blade.php"
    },
    @{
        Local = "D:\OneDrive - MPP TRADE\Skrypty\PPM-CC-Laravel\app\Http\Livewire\Products\VisualDescription\Traits\EditorBlockManagement.php"
        Remote = "app/Http/Livewire/Products/VisualDescription/Traits/EditorBlockManagement.php"
    },
    @{
        Local = "D:\OneDrive - MPP TRADE\Skrypty\PPM-CC-Laravel\app\Http\Livewire\Products\VisualDescription\Traits\EditorPreview.php"
        Remote = "app/Http/Livewire/Products/VisualDescription/Traits/EditorPreview.php"
    }
)
...
Write-Host "Done! VBB CSS Loading fix deployed." -ForegroundColor Green
