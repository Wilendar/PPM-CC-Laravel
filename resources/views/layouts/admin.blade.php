        ...
        <div class="pt-2 lg:grid" :class="sidebarCollapsed ? 'lg:grid-cols-[4rem_1fr]' : 'lg:grid-cols-[16rem_1fr]'">
            ...
            <aside class="relative z-40 transition-all duration-300 ease-in-out"
                 :class="{
                     ...
                     'w-16 sidebar-collapsed': sidebarCollapsed
                 }"
                ...
                <div class="flex flex-col h-full pt-4 pb-4 overflow-y-auto">
                    ...
                    <div class="px-4">
                        <h3 class="sidebar-section-title text-lg font-bold text-white mb-4 flex items-center transition-all duration-300">
                        ...
                        <nav class="space-y-2">
                            ...
                            <!-- Shop Management -->
                            <div class="space-y-1">
                                <div class="flex items-center px-3 py-2 text-xs font-semibold text-gray-400 uppercase tracking-wide transition-all duration-300 sidebar-section-title">
                            ...
                            <div class="space-y-1 pt-4">
                                ...
                                <a href="/admin/reports" class="{{ !($sidebarPerms['reports.read'] ?? false) ? 'sidebar-link-no-access' : '' }} flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-lg hover:bg-gray-700 hover:text-white transition-colors duration-200 {{ request()->is('admin/reports*') ? 'bg-gray-700 text-white' : '' }}"
                                   ...
                                   :class="{ 'justify-center': sidebarCollapsed }">
                                    ...
                                    <span x-show="!sidebarCollapsed" x-transition class="whitespace-nowrap">Raporty</span>
                                </a>
                            </div>
