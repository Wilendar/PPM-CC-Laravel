                    ...
                    <div class="px-4">
                        ...
                        <nav class="space-y-2">
                            ...
                            <div class="space-y-1">
                                ...
                                <a href="/admin/shops/export" class="flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-lg hover:bg-gray-700 hover:text-white transition-colors duration-200 {{ request()->is('admin/shops/export') ? 'bg-gray-700 text-white' : '' }}"
                                   :title="sidebarCollapsed ? 'Eksport masowy' : ''"
                                   :class="{ 'justify-center': sidebarCollapsed }">
                                    <svg class="w-4 h-4 flex-shrink-0"
                                         :class="{ 'mr-0': sidebarCollapsed, 'mr-3': !sidebarCollapsed }"
                                         fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <span x-show="!sidebarCollapsed" x-transition class="whitespace-nowrap">Eksport masowy</span>
                                </a>
                            </div>
                            ...
                            <div class="space-y-1 pt-4">
                                ...
                                <a href="/admin/products" class="flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-lg hover:bg-gray-700 hover:text-white transition-colors duration-200 {{ request()->is('admin/products*') ? 'bg-gray-700 text-white' : '' }}"
