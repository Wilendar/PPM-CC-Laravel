<div class="min-h-screen bg-gray-900">
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-6">
        ...
        @elseif($activeTab === 'smart-matching')
            @livewire('admin.parameters.smart-matching-panel', key('smart-matching-tab'))
        @elseif($activeTab === 'category-type-mappings')
            @livewire('admin.parameters.category-type-mappings-panel', key('category-type-mappings-tab'))
        @elseif($activeTab === 'product-statuses')
            @livewire('admin.parameters.product-status-manager', key('product-statuses-tab'))
        @endif
    </div>
</div>
