                ...
                <div class="relative">
                    ...
                    @if($search)
                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                            <button wire:click="$set('search', '')" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
            ...
            <div class="flex items-center space-x-3">
                ...
                <button wire:click="$toggle('showFilters')" 
                    ...
                    @if($roleFilter !== 'all' || $companyFilter !== 'all' || $statusFilter !== 'all' || $lastLoginFilter !== 'all')
                        <span class="ml-1 bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">●</span>
                    @endif
                </button>
                    ...
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                <button wire:click="sortBy('first_name')" class="flex items-center space-x-1 hover:text-gray-700 dark:hover:text-gray-100">
                                    <span>Nazwa</span>
                            ...
                            @if($visibleColumns['company'])
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                    <button wire:click="sortBy('company')" class="flex items-center space-x-1 hover:text-gray-700 dark:hover:text-gray-100">
                                        <span>Firma</span>
                            ...
                            @if($visibleColumns['last_login'])
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                    <button wire:click="sortBy('last_login_at')" class="flex items-center space-x-1 hover:text-gray-700 dark:hover:text-gray-100">
                            ...
                            <tr class="hover:bg-gray-700 transition-colors duration-150 ease-in-out">
                                ...
                                @if($visibleColumns['email'])
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        @else
                                            <div class="text-xs text-orange-600 dark:text-orange-400 flex items-center">
                                                <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
