<div x-data="permissionMatrix()" class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div>
                ...
                <div class="space-y-1 text-sm">
                    ...
                    <div class="flex justify-between">
                        <span class="text-gray-600 dark:text-gray-400">Użytkowników:</span>
                        <span class="font-medium">{{ $selectedRoleData->users->count() }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-600 dark:text-gray-400">Uprawnień:</span>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div class="flex items-center space-x-2">
                ...
                <select wire:model="bulkAction" 
                        class="px-3 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
        ...
        <div class="border-b border-gray-200 dark:border-gray-700 last:border-b-0">
            ...
            <div class="px-6 py-4">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div class="flex items-center justify-between p-3 rounded-lg border border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                        <div class="flex items-center space-x-3">
                            @if($bulkSelectMode)
                                <input type="checkbox" 
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center">
        ...
        <h3 class="mt-4 text-sm font-medium text-gray-900 dark:text-white">Wybierz rolę</h3>
            ...
            <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="space-y-2 mb-6">
                        <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300">Predefiniowane szablony:</h4>
                    ...
                    <div class="space-y-2">
                        <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300">Niestandardowe szablony:</h4>
    ...
    <div wire:loading wire:target="saveChanges" 
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 flex items-center space-x-3">
            ...
            <span class="text-gray-700 dark:text-gray-300">Zapisywanie uprawnień...</span>
        </div>
    </div>
</div>
