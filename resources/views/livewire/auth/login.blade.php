                ...
                <div>
                    ...
                    <input 
                        ...
                        class="appearance-none rounded-none relative block w-full px-3 py-2 border 
                               ...
                               placeholder-gray-500 text-white rounded-t-md focus:outline-none 
                ...
                <div>
                    ...
                    <input 
                        ...
                        class="appearance-none rounded-none relative block w-full px-3 py-2 border 
                               ...
                               placeholder-gray-500 text-white rounded-b-md focus:outline-none 
                               focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm" 
                        placeholder="Hasło"
        ...
        <div wire:loading.flex wire:target="login" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 items-center justify-center">
            <div class="bg-gray-800 p-8 rounded-lg shadow-lg">
                <div class="flex items-center">
                    ...
                    <span class="ml-3 text-white">Sprawdzanie danych logowania...</span>
                </div>
            </div>
        </div>
    </div>
