...
<div x-data="categoryTreeManager()" x-init="init()" class="space-y-6">
                ...
                <div class="flex rounded-lg bg-gray-100 dark:bg-gray-700 p-1">
                    <button wire:click="$set('viewMode', 'tree')"
                            class="px-3 py-1 text-sm font-medium rounded-md transition-colors
                                   {{ $viewMode === 'tree' ? 'bg-gray-800 dark:bg-gray-600 text-white shadow' : 'text-gray-600 dark:text-gray-300' }}">
                        <i class="fas fa-sitemap mr-1"></i>
                        Drzewo
                    </button>
                    <button wire:click="$set('viewMode', 'flat')"
                            class="px-3 py-1 text-sm font-medium rounded-md transition-colors
                                   {{ $viewMode === 'flat' ? 'bg-gray-800 dark:bg-gray-600 text-white shadow' : 'text-gray-600 dark:text-gray-300' }}">
                ...
                @if($viewMode === 'tree')
                    <div class="flex gap-1">
                        <button wire:click="expandAll"
                                class="px-3 py-2 text-sm bg-gray-100 dark:bg-gray-700 text-gray-300 rounded-md hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="relative">
                    <input wire:model.debounce.300ms="search"
                           type="text"
                           id="search"
                           class="w-full pl-10 pr-4 py-2 border border-gray-600 rounded-md bg-gray-700 text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div>
                ...
                <select wire:model="showActiveOnly"
                        class="w-full px-3 py-2 border border-gray-600 rounded-md bg-gray-700 text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
    ...
    <div class="bg-gray-800 rounded-lg shadow overflow-hidden">
        ...
        <div wire:loading.class="block" wire:loading.class.remove="hidden"
             ...
             class="hidden absolute inset-0 bg-gray-800 bg-opacity-75 dark:bg-gray-800 dark:bg-opacity-75 flex items-center justify-center z-10">
            <div class="flex items-center space-x-2">
    ...
    @if($showModal)
        <div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50"
            ...
            <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-gray-800">
                ...
                {{-- Modal Footer --}}
                <div class="flex items-center justify-end pt-4 mt-6 border-t border-gray-700 space-x-2">
                    <button wire:click="closeModal"
                            class="px-4 py-2 text-sm font-medium text-gray-300 bg-gray-100 dark:bg-gray-700 rounded-md hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                        Anuluj
                    </button>
