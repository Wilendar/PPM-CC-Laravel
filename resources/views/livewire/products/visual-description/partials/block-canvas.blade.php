...
<style>
    ...
    {{-- @safe: canvasPreviewCss is generated by StylesetCompiler from internal PPM styleset data, never from user input --}}
        ...
        <div class="product-description">
            ...
            @foreach($blocks as $index => $block)
                ...
                >
                    ...
                    {{-- Block Preview --}}
                    {{-- @safe: renderBlockPreview() calls BlockRegistry->render() which generates HTML from internal block definitions --}}
