{{-- ETAP_05b PHASE 6 + ETAP_05f: Variant Edit Modal with Auto SKU --}}
    ...
    <div class="flex min-h-screen items-center justify-center p-4">
        <div class="relative bg-gray-800 rounded-xl shadow-2xl max-w-2xl w-full border border-gray-700"
                    ...
                    @if($attributeTypes->count() > 0)
                        <div class="space-y-3">
                            @foreach($attributeTypes as $type)
                                <div wire:key="attr-type-edit-{{ $type->id }}" class="bg-gray-900/50 border border-gray-700 rounded-lg p-3">
            ...
            <div class="flex items-center justify-end space-x-3 px-6 py-4 bg-gray-900/50 border-t border-gray-700 rounded-b-xl">
                ...
                <button type="button"
                        wire:click="updateVariant"
                        wire:loading.attr="disabled"
                        class="btn-enterprise-primary px-6 py-2">
                    <span wire:loading.remove wire:target="updateVariant">Zapisz Zmiany</span>
                    <span wire:loading wire:target="updateVariant">
