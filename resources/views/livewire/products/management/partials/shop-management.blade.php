...
{{-- SECURITY: Only show shop management if user has compliance_read --}}
...
<div class="mt-3 bg-gray-800 rounded-lg p-3">
    <div class="flex items-center space-x-2 text-gray-500">
        ...
        <span class="text-sm">Zarządzanie sklepami — <span class="censored-value">brak uprawnień</span></span>
    </div>
</div>
@else
<div class="mt-3 bg-gray-800 rounded-lg p-3">
                ...
                @foreach($exportedShops as $shopId)
                    ...
                    @if($shop)
                        <div wire:key="shop-label-{{ $shopId }}" class="inline-flex items-center group">
                            ...
                            {{-- Visibility Toggle - height matches label --}}
                            <button type="button"
                            ...
                            {{-- Delete from PrestaShop Button (Physical Delete) - height matches label --}}
                            <button type="button"
                                    ...
                                    class="px-3 py-2 text-xs bg-red-700 hover:bg-red-800 text-white transition-all duration-200 flex items-center opacity-0 group-hover:opacity-100">
                                <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd"/>
                                </svg>
                            </button>

                            {{-- Remove Association Button (Local only) - height matches label --}}
                            <button type="button"
                                    ...
                                    class="px-3 py-2 text-xs bg-orange-500 hover:bg-orange-600 text-white rounded-r-lg transition-all duration-200 flex items-center opacity-0 group-hover:opacity-100">
