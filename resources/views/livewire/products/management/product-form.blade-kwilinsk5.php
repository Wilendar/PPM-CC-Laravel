    ...
    <form wire:submit.prevent="save">
        <div class="category-form-main-container">
                ...
                <div class="{{ $activeTab === 'basic' ? '' : 'hidden' }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            {{-- FIX #3 2025-11-21: Loading spinner for shop categories --}}
                            <div wire:loading.delay wire:target="switchToShop" class="flex items-center justify-center py-8">
                                <div class="flex flex-col items-center gap-3">
                                    <svg class="w-8 h-8 text-mpp-orange animate-spin" fill="none" viewBox="0 0 24 24">
                                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                    </svg>
                                    <p class="text-sm text-gray-400">Wczytywanie kategorii sklepu...</p>
                                </div>
                            </div>

                            <div wire:loading.remove wire:target="switchToShop">
                                {{-- FIX 2025-11-21 v5: ROLLBACK - calculate expansion IDs in @php block (property pass broke layout) --}}
                                @php
            ...
            <div class="category-form-right-column">
                ...
                @endif
            </div> {{-- Close category-form-right-column --}}
