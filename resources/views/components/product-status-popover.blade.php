...
<div x-data="{ open: false }"
    ...
    <button type="button"
            class="inline-flex items-center justify-center w-7 h-7 rounded border {{ $severityConfig['bg'] }} {{ $severityConfig['border'] }} {{ $severityConfig['text'] }} cursor-pointer transition-all hover:scale-105"
