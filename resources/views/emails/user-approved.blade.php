                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #16213e; border-radius: 12px; overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            <h2 style="color: #e0ac7e; margin: 0 0 20px;">Twoje konto zostalo zatwierdzone!</h2>
                            ...
                            <p style="color: #d1d5db; font-size: 16px; line-height: 1.6; margin: 0 0 25px;">
                                Twoje konto w systemie PPM zostalo zatwierdzone przez administratora. Mozesz teraz zalogowac sie do systemu.
                            </p>
                            <table cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                                <tr>
                                    <td style="background: linear-gradient(135deg, #e0ac7e, #d1975a); border-radius: 8px;">
                                        <a href="{{ url('/login') }}" style="display: inline-block; padding: 14px 32px; color: #fff; text-decoration: none; font-weight: bold; font-size: 16px;">
                                            Zaloguj sie do PPM
                                        </a>
                                    </td>
                                </tr>
